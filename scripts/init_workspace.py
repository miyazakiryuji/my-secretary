...
使い方:
    ...
    python3 init_workspace.py --plugin-root <プラグインのパス>
        # プラグインの workspace-skills/ から、この執務室専用のスキル12点
        # （予定・締切/返事待ち・思い出し・申し送り・学習・人物・代筆・定型業務・
        #   自分仕様・繰り返し・見積もり・取り込み）を .claude/skills/ へ複製する
...
（隠しフォルダ `.claude/skills/` には、この執務室**専用**の秘書スキル12点
〔予定・締切/返事待ち・思い出し・申し送り・学習・人物/打ち合わせ準備・代筆・定型業務・
自分仕様・繰り返し・見積もり・取り込み〕が入っています。触らなくて大丈夫ですが、
